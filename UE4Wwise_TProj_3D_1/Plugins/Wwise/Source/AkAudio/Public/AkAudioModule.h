...
public:
	static const FName GetAkAudioModuleName() 
	{
		const FName ModuleName = TEXT("AkAudio");
		return ModuleName;
	}
	...
	{
		return FModuleManager::LoadModuleChecked< IAkAudioModule >(GetAkAudioModuleName());
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded(GetAkAudioModuleName());
	}
};
