...
#pragma once
/// \file
/// Registers the Wwise Reflect plugin automatically.
...
/// <br><b>Wwise plugin name:</b>  Wwise Reflect
/// <br><b>Library file:</b> AkReflectFX.lib

AK_STATIC_LINK_PLUGIN(AkReflectFX)
